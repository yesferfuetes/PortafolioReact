...
const Contact = () => {
  return (
    <div name="contact" className='w-duññ h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form 
                action="https://getform.io/f/28cb5835-4d24-40c5-b84e-57cc379887cc"
                method='POST' 
